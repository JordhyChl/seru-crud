package com.seru.serujuragan.ui.home.crd
...
import com.seru.serujuragan.ui.home.DatabaseHandler
import com.seru.serujuragan.ui.home.EmpModelClass
import com.seru.serujuragan.ui.home.MyListAdapter
...
class CRUDActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbarTitle.text = "CRUD CONTOH"
        toolbarBackBtn.setOnClickListener {
            onBackPressed()
        }
        val dbHandler: DatabaseHandler = DatabaseHandler(this)
        //calling the viewEmployee method of DatabaseHandler class to read the records
        val emp: List<EmpModelClass> = dbHandler.viewEmployee()
    ...
    fun updateRecord(view: View){
        ...
        dialogBuilder.setPositiveButton("Update", DialogInterface.OnClickListener { _, _ ->
            ...
            val dbhndlr: DatabaseHandler = DatabaseHandler(this)
            //calling the viewEmployee method of DatabaseHandler class to read the records
            val emp: List<EmpModelClass> = dbhndlr.viewEmployee()
            val empArrayId = Array<String>(emp.size){"0"}
            val empArrayName = Array<String>(emp.size){"null"}
            val empArrayEmail = Array<String>(emp.size){"null"}
            var index = 0
    ...
    fun deleteRecord(view: View){
        ...
        dialogBuilder.setPositiveButton("Delete", DialogInterface.OnClickListener { _, _ ->
            ...
            val deletedb: DatabaseHandler = DatabaseHandler(this)
            //calling the viewEmployee method of DatabaseHandler class to read the records
            val emp: List<EmpModelClass> = deletedb.viewEmployee()
            val empArrayId = Array<String>(emp.size){"0"}
            val empArrayName = Array<String>(emp.size){"null"}
            val empArrayEmail = Array<String>(emp.size){"null"}
            var index = 0
