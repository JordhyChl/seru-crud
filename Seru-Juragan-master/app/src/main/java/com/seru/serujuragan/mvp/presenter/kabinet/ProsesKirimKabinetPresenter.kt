 ...
 */
class ProsesKirimKabinetPresenter: ProsesKirimKabinetContract.Presenter {

    private val TAG = ProsesKirimKabinetPresenter::class.java.simpleName
    private val subscriptions = CompositeDisposable()
    private val apiService: ApiService = ApiService.create()
    private val exportService: ApiService = ApiService.export()
    private lateinit var view: ProsesKirimKabinetContract.View
    ...
    override fun attach(view: ProsesKirimKabinetContract.View) {
        this.view = view
    }
}