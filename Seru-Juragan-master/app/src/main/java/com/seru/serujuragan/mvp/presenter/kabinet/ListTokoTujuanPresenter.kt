 ...
 */
class ListTokoTujuanPresenter : ListTokoTujuanContract.Presenter{

    private val TAG = ListStatusCabinetPresenter::class.java.simpleName
    private val subscriptions = CompositeDisposable()
    private val apiService: ApiService = ApiService.create()
    private lateinit var view: ListTokoTujuanContract.View
    private val contentType = Constants.CONTENT_TYPE
    private val token = AppPreference.token

    override fun loadListTokoTujuan(idTokoAsal: String, idTokoTujuan:String, namaToko:String, noToko:String) {
        var subscribe = apiService.getListOutletTujuan(contentType, token, idTokoAsal, idTokoTujuan, namaToko, noToko)
    ...
    override fun attach(view: ListTokoTujuanContract.View) {
        this.view = view
    }
